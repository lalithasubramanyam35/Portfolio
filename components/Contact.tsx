  ...
  return (
    <AnimatedSection id="contact">
      <div className="max-w-2xl mx-auto text-center">
        ...
        <a href="mailto:lalitha.s@email.com" className="inline-block bg-transparent text-accent border-2 border-accent rounded-md px-8 py-4 font-mono hover:bg-accent/10 transition-all duration-300 text-lg">
          Drop a Line
        </a>
      </div>
    </AnimatedSection>
